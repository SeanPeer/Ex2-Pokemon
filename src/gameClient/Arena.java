...
public class Arena {
    ...
    public static ArrayList<CL_Pokemon> json2Pokemons(String fs) {
        ...
        try {
            ...
            for(int i=0;i<ags.length();i++) {
                ...
                CL_Pokemon f = new CL_Pokemon(new Point3D(p), t, v, 0, find_edge(new Point3D(p), t, _gg));
    ...
    public static edge_data find_edge(geo_location fr_loc, int fr, directed_weighted_graph g) {
        ...
        while(itr.hasNext()) {
            ...
            while(iter.hasNext()) {
                ...
                boolean f = isOnEdge(fr_loc, e, fr, g);
                if(f) {
                    return e;
                }
            }
